...
(function() {
  ...
  (typeof exports !== "undefined" && exports !== null ? exports : this).tuner = (function() {
    var audioContext, buffer, bufferFiller, canvas, context, fft, fftSize, gauss, hp, init, interval, kill, lp, maxPeakCount, maxPeaks, maxTime, noiseCount, noiseThreshold, sampleRate, update, _alertError, _success;
    ...
    _success = function(stream) {
      var display, e, getPitch, interval, process, src;
      try {
    ...
    init = function($container) {
      var $CONTAINER, bufferFillSize, i;
      $CONTAINER = $container;
      $CONTAINER.empty();
      canvas = $('<canvas>').get(0);
      ...
      $(window).resize(function() {
        ...
        return canvas.width = $CONTAINER.width();
      });
