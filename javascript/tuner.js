...
(function() {
  ...
  Tuner = function() {
    var analyser, audioContext, buffer, bufferFillSize, bufferFiller, error, fft, fftSize, gauss, getPitch, hp, i, lp, sampleRate, success;
    ...
    success = function(stream) {
      ...
      data = function() {
        var b, bufferCopy, diff, display, displayStr, downsampled, f, firstFreq, freq, freqWidth, left, newMaxTime, noiseThrehold, note, p, peak, peaks, pitch, q, right, s, secondFreq, spectrumPoints, thirdFreq, timeWidth, upsampled, x, _i, _j, _k, _l, _len, _m, _n, _o, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _results;
        bufferCopy = (function() {
        ...
        for (s = _k = 0, _ref1 = upsampled.length; 0 <= _ref1 ? _k < _ref1 : _k > _ref1; s = 0 <= _ref1 ? ++_k : --_k) {
        ...
        _results = [];
        for (f = _o = 10, _ref7 = (fft.spectrum.length / 4) - 10; 10 <= _ref7 ? _o < _ref7 : _o > _ref7; f = 10 <= _ref7 ? ++_o : --_o) {
