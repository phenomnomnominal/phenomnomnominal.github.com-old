...
(function() {
  var CAMERA, Clouds, RENDERER, SCENE, World, pAct, pExt, pHum, root, start_time, windSpeed, xSmooth, ySmooth, zSmooth;
  ...
  Clouds = function() {
    var $container, animate, fog, geometry, height, i, material, mesh, plane, render, target, texture, width, _i;
    ...
    fog = new THREE.Fog(0x4584b4, -100, 5000);
