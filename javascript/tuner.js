...
(function() {
  ...
  Tuner = function() {
    var analyser, audioContext, buffer, buffer2, buffer3, bufferFillSize, bufferFiller, downsampleRate, error, fft, fftSize, hamming, hp, i, lp, options, sampleRate, success, _i, _ref;
    ...
    bufferFiller.onaudioprocess = function(e) {
      ...
      for (i = _k = 0, _ref2 = input.length; 0 <= _ref2 ? _k < _ref2 : _k > _ref2; i = 0 <= _ref2 ? ++_k : --_k) {
        buffer3.push(input[0]);
        buffer2[buffer.length - (bufferFillSize + i)] = input[0];
